...
# Big Hoss (Storage Drive) - Raw footage and everything else
mkdir -p "$STORAGE_DRIVE/01_Inbox_ToSort"
mkdir -p "$STORAGE_DRIVE/01_Inbox_ToSort/processing"
...
echo "  └── NubHQ/"
echo "      ├── 01_Inbox_ToSort/  <- Drop raw footage here"
...
echo "  $STORAGE_DRIVE/01_Inbox_ToSort"
